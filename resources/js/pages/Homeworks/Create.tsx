  ...
  return (
    <AppLayout>
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={(e) => { e.preventDefault(); router.post(route('homeworks.store'), formData); }} className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <TextInput label="Due Date" type="date" value={formData.due_date} onChange={(e) => setFormData({ ...formData, due_date: e.target.value })} required />
