...
export default function Create({ students, approvers }: Props) {
  ...
  const submit = (event: FormEvent<HTMLFormElement>) => {
    ...
    router.post(route('leave-requests.store'), payload, { preserveScroll: true });
  };
  ...
  return (
    <AppLayout>
      ...
      <div className="mx-auto w-full max-w-3xl space-y-6 p-4 md:p-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Create Leave Request</h1>
          <p className="text-sm text-muted-foreground">Submit a leave request using current field bindings.</p>
        </div>
