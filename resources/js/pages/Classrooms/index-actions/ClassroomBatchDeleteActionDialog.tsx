...
export default function ClassroomBatchDeleteActionDialog({
  open,
  selectedCount,
  batchDeleteLimit,
  ...
  onConfirmDelete,
  onCancel,
}: ClassroomBatchDeleteActionDialogProps) {
  return (
