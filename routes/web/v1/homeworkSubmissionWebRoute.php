...
use App\Http\Controllers\Web\V1\HomeworkSubmissionController;
use Illuminate\Support\Facades\Route;

Route::prefix('homework-submissions')->name('homework-submissions.')->controller(HomeworkSubmissionController::class)->group(function () {
...
Route::resource('homework-submissions', HomeworkSubmissionController::class);
